...
| Extraction refinements | 🟦 Next | Even-spaced sampling (ffprobe duration), blur/`phash` frame dedup, CLIP/enrich. Also: capture `order.shippingAddress` for Shippo (held). |
